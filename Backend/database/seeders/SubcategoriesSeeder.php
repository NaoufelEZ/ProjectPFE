...
class SubcategoriesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Subcategories::factory()->createMany([
            ...
            ["category_id"=>1,"subcategories"=>"New","subcategories_image"=>"1741881722_67d3017a0e567.jpg"],
            ["category_id"=>2,"subcategories"=>"New","subcategories_image"=>"1741881684_67d30154f0b4b.webp"],
        ]);
    }
}
